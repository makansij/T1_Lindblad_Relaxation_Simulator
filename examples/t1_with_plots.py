...
if __name__ == "__main__":
    ...
    plt.plot(t * 1e6, rho00, label='Simulated ρ00(t)')
    plt.plot(t * 1e6, p1, label='Simulated ρ11(t)')
    plt.plot(t * 1e6, coh01, label='Simulated |ρ01(t)|')
    plt.plot(t * 1e6, rho01.real, label='Simulated Re ρ01(t)')
    plt.plot(t * 1e6, rho01.imag, label='Simulated Im ρ01(t)')
    plt.plot(t * 1e6, rho10.real, '--', label='Simulated Re ρ10(t)')
    plt.plot(t * 1e6, rho10.imag, '--', label='Simulated Im ρ10(t)')
